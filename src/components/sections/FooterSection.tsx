...
const FooterSection = () => {
  ...
  const socialLinks = [
    ...
    { icon: MessageCircle, href: "https://wa.me/553498960962", label: "WhatsApp" },
  ];
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-primary-foreground/70">
                ...
                <a href="tel:+553498960962" className="hover:text-primary transition-colors">
                  +55 34 9896-0962
                </a>
              </li>
          ...
          >
            ...
            <a
              href="https://wa.me/553498960962?text=Olá! Quero agendar minha avaliação gratuita."
              target="_blank"
              rel="noopener noreferrer"
